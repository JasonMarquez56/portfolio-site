const Navbar = () => {
  return(
    <div className="fixed flex top-0 left-0 w-full justify-between bg-[#252423]/50 backdrop-blur-md text-white px-8 py-8 z-50">
      <p className="font-semibold justify !text-[#fe8019]">Jason Marquez</p>
      <div className="flex justify-end px-4 gap-12">
